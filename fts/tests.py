...
class PollsTest(LiveServerTestCase):
    ...
    #     password_field.send_keys('neoublie')
    ...
    #     # She sets the date and time of the publication - it'll be a new year's
    #     # poll!
    ...
    def _setup_polls_via_admin(self):
        ...
        for poll_info in [POLL1, POLL2]:
            ...
            # She sees she can enter choices for the Poll on this same page,
            # so she does
    ...
    def test_voting_on_a_new_poll(self):
        ...
        body_text = self.browser.find_element_by_tag_name('body').text
        self.assertIn('100 %: Very awesome')
